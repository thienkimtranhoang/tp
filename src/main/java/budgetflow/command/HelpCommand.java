...
public class HelpCommand extends Command {
    ...
    public void execute(List<Income> incomes, ExpenseList expenseList) throws FinanceException {
        ...
        helpMessage.append("To add an Expense: log-expense category/<CATEGORY> desc/<DESCRIPTION> amt/<AMOUNT>" +
                " d/<DD-MM-YYYY>\n" + RESET);
        helpMessage.append("To View all expenses: list-expense\n" + CYAN);
        ...
        helpMessage.append("To filter Expenses:\n" + CYAN +
                "filter-expense /desc <DESCRIPTION>\n" + YELLOW +
                "OR filter-expense /d <DD-MM-YYYY>\n" + CYAN +
                "OR filter-expense /amt <AMOUNT>\n" + YELLOW +
                "OR filter-expense /category <CATEGORY>\n" + CYAN +
                "OR filter-expense /amtrange <AMOUNT 1> <AMOUNT 2>\n" + YELLOW +
                "OR filter-expense /drange <DATE 1> <DATE 2>\n" + CYAN);
