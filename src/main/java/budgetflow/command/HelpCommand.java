...
public class HelpCommand extends Command {
    ...
    public void execute(List<Income> incomes, ExpenseList expenseList) throws FinanceException {
        ...
        helpMessage.append("To add an Expense: log-expense category/[CATEGORY] desc/[DESCRIPTION] amt/[AMOUNT] d/[DD-MM-YYYY]\n");
        ...
        helpMessage.append("To find an Expense: find-expense /desc [DESCRIPTION] OR /d [DD-MM-YYYY] OR /amt [AMOUNT] OR /category [CATEGORY] OR /amtrange [AMOUNT 1] [AMOUNT 2] OR /drange [DATE 1] [DATE 2]\n");
        helpMessage.append("To compare expenses from 2 months: compare [MM-YYYY] [MM-YYYY]\n");
        helpMessage.append("To Update an expense: update-expense category/[CATEGORY] OR amt/[AMOUNT] OR desc/[DESCRIPTION] d/[DD-MM-YYYY]\n");
        helpMessage.append("To Update an Income : update-income category/[CATEGORY] OR amt/[AMOUNT] OR d/[DD-MM-YYYY]\n");
