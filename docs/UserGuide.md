...
| `delete-income <INDEX OF INCOME ENTRY>`                                                                               | Deletes an income entry with the given index.                       |
| `delete-expense <INDEX OF EXPENSE ENTRY>`                                                                             | Deletes an expense entry with the given index.                      |
